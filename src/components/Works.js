      ...
      <div className="project-carousel">
        <Carousel>
          ...
          <div className="slide">
            ...
            <p>I embarked on the journey of building this E-commerce application with the objective of crafting a robust set of routes tailored for internet retailers. The motivation behind this project was to empower retail owners with a comprehensive platform that streamlines inventory management, thus enhancing the overall retail experience.
          ...
          <div className="slide">
            ...
            <p>The Horiseon marketing agency needed to refactor its website. 
              ...
              the code to be more accessible use.</p>
          </div>
          <div className="slide">
